...
Versione del documento / Document version: 2026-08-22 · Applicazione / Application: 1.15.0
...
- L’audit npm è eseguito localmente e in CI; al 2026-08-08 riporta 0 vulnerabilità note dopo gli override compatibili di `uuid >=11.1.1` per ExcelJS e di `shell-quote >=1.10.0`, `brace-expansion >=5.0.9` e `postcss >=8.5.23` per la toolchain di sviluppo, oltre agli aggiornamenti transitivi correttivi `js-yaml 4.3.1` e `nanoid 3.3.18`.
