...
5. Usa **Transazioni** per entrate e uscite quotidiane: i riepiloghi filtrati separano Conto e Cassa. La Panoramica mostra anche il saldo complessivo delle Casse; in **Automobile** puoi aggiungere al mezzo un unico finanziamento collegato alle Ricorrenze; gli altri menu gestiscono immobili, investimenti, pensione integrativa, ricorrenze e spese condivise.
...
5. Use **Transactions** for everyday income and expenses: filtered summaries separate accounts from cash registers. Overview also shows the total cash-register balance; under **Vehicles** you can add one financing plan linked to Recurring Items; the other views manage properties, investments, private pensions, recurring items, and shared expenses.
