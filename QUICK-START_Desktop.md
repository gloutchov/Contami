...
5. Usa **Transazioni** per entrate e uscite quotidiane: i riepiloghi separano Conto e Cassa, il saldo esclude i saldi iniziali quando applichi un filtro e le due righe alla data odierna restano sempre assolute e non filtrate. La Panoramica mostra anche il saldo complessivo delle Casse; nelle nuove spese di **Immobili** e **Automobile** puoi scegliere **Dividi automaticamente a metà** per creare anche la Spesa condivisa collegata; in Automobile puoi inoltre aggiungere al mezzo un unico finanziamento collegato alle Ricorrenze.
...
5. Use **Transactions** for everyday income and expenses: summaries separate accounts from cash registers, balances exclude opening balances when a filter is active, and the two as-of-today rows remain absolute and unfiltered. Overview also shows the total cash-register balance; new **Property** and **Vehicle** costs offer **Split automatically in half** to create the linked Shared Expense; Vehicles can also own one financing plan linked to Recurring Items.
