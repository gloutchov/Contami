...
6. In **Investimenti** o **Pensione integrativa**, controlla nei quattro box capitale iniziale, versamenti successivi, liquidazioni e saldo. Le card mostrano il rendimento annuale e il dettaglio quello mensile sotto al controvalore; aggiorna periodicamente il valore per evitare lacune. Gli immobili in affitto mostrano gli stessi periodi come rendimento locativo netto. **Correzione** non entra nel calcolo del rendimento.
...
6. In **Investments** or **Private pension**, review initial capital, subsequent contributions, liquidations, and balance in the four boxes. Cards show annual returns and details show monthly returns below countervalue; update valuations regularly to avoid gaps. Rental properties show the same periods as net rental yield. **Correction** is excluded from return calculations.
