...
import { confirmedInvestmentEntries, investmentPositionIsLoss, investmentPositionValue, pensionCompartments, pensionInvestmentIds, pensionPlans, portfolioValues } from "../../domain/investments";
