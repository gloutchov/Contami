...
Ogni card mostra un grafico compatto del **rendimento annuo**; nel dettaglio, sotto al confronto tra cifra investita e controvalore, compare il **rendimento percentuale mensile**. ContaMì usa Modified Dietz per separare la performance dai Versamenti e dalle Liquidazioni confermati: Correzioni e pianificazioni sono escluse. Il tooltip mostra valore iniziale, valore finale, flussi netti e base ponderata. Un mese senza una valutazione sufficiente resta vuoto; gli anni completi collegano geometricamente i mesi disponibili, mentre i consuntivi annuali privi di dettaglio producono soltanto una **stima** dichiarata con l’ipotesi di flussi a metà periodo. Un primo anno storico privo del valore iniziale non viene inventato.
