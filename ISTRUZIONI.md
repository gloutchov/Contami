...
Ogni card mostra un grafico compatto del **rendimento annuo**; nel dettaglio, sotto al confronto tra cifra investita e controvalore, compare il **rendimento percentuale mensile**. Ogni punto confronta l’ultima valutazione confermata del mese con quella osservata nel mese precedente e applica Modified Dietz all’intervallo effettivo fra le due date, separando la performance dai Versamenti e dalle Liquidazioni intercorsi; Correzioni e pianificazioni sono escluse. Il tooltip mostra date osservate, valore iniziale, valore finale, flussi netti e base ponderata. Un mese senza valutazione resta vuoto e il successivo intervallo su più mesi è indicato come parziale. Gli anni completi collegano geometricamente dodici intervalli coperti; i consuntivi di due anni consecutivi producono invece una **stima** dichiarata dal valore di chiusura precedente e corrente, con l’ipotesi di flussi a metà periodo. Il primo anno privo di un valore iniziale non viene inventato.
