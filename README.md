...
- Grafici per ogni investimento e comparto pensione che confrontano nel tempo capitale investito e controvalore e, subito sotto, mostrano il rendimento mensile Modified Dietz depurato dai flussi. Le card includono l’andamento annuale percentuale, con stime storiche e periodi parziali dichiarati. Pagina, schede e dettagli mostrano inoltre capitale iniziale, versamenti successivi, liquidazioni totali e saldo investito/liquidato; **Correzione** rettifica solo questi riepiloghi e non entra nel rendimento.
...
- Per-position investment and pension-compartment charts compare net invested capital with countervalue and then show cash-flow-adjusted monthly Modified Dietz returns. Cards include annual percentage trends, with historical estimates and partial periods identified. Pages, cards, and details also show initial invested capital, subsequent contributions, total liquidations, and invested/liquidated balance; **Correction** changes those summaries only and is excluded from returns.
