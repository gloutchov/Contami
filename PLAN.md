...
| M11 — CSP senza stili inline | `milestone/11-strict-csp` | `1.13.0` | Completata localmente; gate Windows verde |
| M23 — Landing page bilingue | `milestone/23-landing-page` | `1.14.0` | Completata anticipatamente; tag web separato `landing-v1.0.0`, checkpoint applicativo dopo M10/M11 |
...
- È stata aggiunta M23 come ultima milestone della roadmap: realizzerà in `docs/` il sito bilingue compatibile con GitHub Pages, con identità visiva ContaMì, panoramica delle funzioni, screenshot/GIF sintetici e link a download e repository; il checkpoint previsto è `v1.14.0`.
