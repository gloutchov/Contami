...
**Esito locale 2026-09-05:** implementate trasformazioni pure di dominio per Modified Dietz mensile, collegamento geometrico annuale, stime annuali Original Dietz dichiarate, copertura completa/parziale/mancante e aggregazione di gruppi e pensioni-raccoglitore prima del calcolo. Ogni punto mensile confronta ora due valutazioni osservate consecutive sull’intervallo effettivo fra le date e include i soli flussi intercorsi; osservazioni in mesi consecutivi producono punti consecutivi anche senza date di fine mese, mentre una valutazione mensile davvero assente resta una lacuna e il successivo intervallo su più mesi è parziale. I consuntivi di chiusura di due anni consecutivi generano in memoria una stima annuale anche sui workbook migrati v10 e nei singoli comparti pensionistici, senza riscrivere lo storico né inventare il primo valore iniziale. Investimenti e comparti mostrano il grafico mensile sotto cifra investita/controvalore e il grafico annuale compatto nelle card; gli immobili locati applicano lo stesso layout al rendimento netto, usando competenza dei canoni, spese confermate e valore commerciale. Lacune, valute miste, denominatori non validi, stime e YTD sono espliciti; i tooltip espongono anche le date osservate, oltre a copertura e componenti origine, e ogni periodo è raggiungibile da tastiera. Un affitto pagato dopo il passaggio d'anno viene attribuito al consuntivo dell'anno di competenza e conservato al rollover successivo. Lo schema workbook è v11: `Investment History` conserva il rendimento annuale già calcolato, metodo, copertura, stato parziale e data dell’ultima osservazione; un valore iniziale trascinato non diventa uno `0%` misurato. I punti mensili restano derivati e non cambiano IPC, preload o rete. Versione portata a `1.17.0`, documentazione e glossario bilingue aggiornati. Con dati esclusivamente sintetici sono verdi lint, typecheck, 252 test Vitest in 44 file, build renderer/Electron, controllo dei 15 documenti obbligatori, baseline Node.js, CSP rigorosa, `npm audit` con zero vulnerabilità e tutti gli 11 test Playwright automatici. Il workflow Playwright CLI ha verificato investimenti e comparti in italiano/tema chiaro e inglese/tema scuro a 1080 px, inclusi serie mensili consecutive, stime annuali, tooltip bilingui con intervallo osservato e assenza di errori console; il collaudo M27 precedente copriva inoltre immobili locati, lacune, focus da tastiera e badge stima/parziale. Nessun workbook privato è stato aperto, modificato o usato come fixture.
