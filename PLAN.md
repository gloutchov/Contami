...
| M23 — Landing page bilingue | `milestone/23-landing-page` | `1.14.0` | Completata anticipatamente; patch web `landing-v1.0.1` e Pages da `main/docs` verdi |
