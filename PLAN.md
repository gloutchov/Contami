...
| M27 — Rendimenti percentuali patrimoniali | `milestone/27-asset-return-charts` | `1.17.0` | Implementata e verificata localmente; CI/release da eseguire |
...
**Checkpoint desktop pronto localmente:** `v1.17.0` con M27, non ancora promosso; l'ultimo checkpoint completato e pubblicato è `v1.16.0` con M26.
