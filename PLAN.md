...
**Stato corrente:** la roadmap è stata riaperta il 2026-08-08 con M24, ora completata e pubblicata come release desktop `v1.14.0`. M23 segue un versionamento web separato: la revisione pubblicata più recente è `landing-v1.0.1`, mentre la patch localizzata dei collegamenti ai manuali è implementata e verificata localmente come `landing-v1.0.2`, non ancora pubblicata. Le sezioni **Attività pianificate** delle milestone già chiuse conservano il perimetro originario e non rappresentano lavoro ancora da eseguire.
