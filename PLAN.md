...
**Esito locale 2026-09-05:** implementate trasformazioni pure di dominio per Modified Dietz mensile, collegamento geometrico annuale, stime annuali Original Dietz dichiarate, copertura completa/parziale/mancante e aggregazione di gruppi e pensioni-raccoglitore prima del calcolo. Investimenti e comparti mostrano il grafico mensile sotto cifra investita/controvalore e il grafico annuale compatto nelle card; gli immobili locati applicano lo stesso layout al rendimento netto, usando competenza dei canoni, spese confermate e valore commerciale. Lacune, valute miste, denominatori non validi, stime e YTD sono espliciti; i tooltip espongono copertura e componenti origine e ogni periodo è raggiungibile da tastiera. Un affitto pagato dopo il passaggio d'anno viene attribuito al consuntivo dell'anno di competenza e conservato al rollover successivo. Lo schema workbook è v11: `Investment History` conserva il rendimento annuale già calcolato, metodo, copertura, stato parziale e data dell’ultima osservazione; la migrazione v10→v11 lascia assente lo storico non ricostruibile e un valore iniziale trascinato non diventa uno `0%` misurato. I punti mensili restano derivati e non cambiano IPC, preload o rete. Versione portata a `1.17.0`, documentazione e glossario bilingue aggiornati. Con dati esclusivamente sintetici sono verdi lint, typecheck, 250 test Vitest in 44 file, build renderer/Electron, controllo dei 15 documenti obbligatori, baseline Node.js, CSP rigorosa, `npm audit` con zero vulnerabilità e tutti gli 11 test Playwright automatici. Il workflow Playwright CLI ha verificato investimenti, pensioni e immobili locati in italiano/tema chiaro e inglese/tema scuro a 1080 px, inclusi badge stima/parziale, lacune, tooltip sorgente e focus da tastiera, senza errori console. Nessun workbook privato è stato aperto, modificato o usato come fixture.
