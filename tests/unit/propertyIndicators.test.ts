...
describe("residence indicators", () => {
  it("aggregates bilingual utility and household labels for the selected year", () => {
    const result = summarizeResidenceEntries([
      entry("33333333-3333-4333-8333-333333333333", { kind: "expense", category: "Utenze", description: "Bolletta", detailKind: "utility_electricity", electricityKwhF1: 100, electricityKwhF23: 220, amount: 85 }),
      entry("44444444-4444-4444-8444-444444444444", { category: "Servizi", description: "Canone", detailKind: "utility_phone_internet", amount: 180 }),
    ...
    expect(result).toMatchObject({ electricity: 320, electricityCost: 85, phoneInternet: 180, tvLicence: 90, condominium: 540 });
  });
});
